...
from Learn1Week2.lr_utils import load_dataset
...
# d = model(train_set_x, train_set_y, test_set_x, test_set_y, num_iterations = 2000, learning_rate = 0.011, print_cost = True)
# #绘制图
